...
with open(files, 'r') as in_file:
	...
	for i in xrange(0, len(json_data)):
		...
		try:
			# print (json_data[i]["_source"]["layers"]["lte-rrc.DL_CCCH_Message_element"]["lte-rrc.message_tree"]["lte-rrc.c1_tree"]["lte-rrc.rrcConnectionReestablishment_element"]["lte-rrc.criticalExtensions_tree"]["lte-rrc.c1_tree"])

			if "lte-rrc.rrcConnectionReestablishment_r8_element" in json_data[i]["_source"]["layers"]["lte-rrc.DL_CCCH_Message_element"]["lte-rrc.message_tree"]["lte-rrc.c1_tree"]["lte-rrc.rrcConnectionReestablishment_element"]["lte-rrc.criticalExtensions_tree"]["lte-rrc.c1_tree"]:
				...
				reject_opt_field.append(json_data[i]["_source"]["layers"]["lte-rrc.DL_CCCH_Message_element"]["lte-rrc.message_tree"]["lte-rrc.c1_tree"]["lte-rrc.rrcConnectionReestablishment_element"]["lte-rrc.criticalExtensions_tree"]["lte-rrc.c1_tree"]["lte-rrc.rrcConnectionReestablishment_r8_element"]["per.optional_field_bit"])
				...
				try:
					...
					lateNonCriticalExtention_len.append(json_data[i]["_source"]["layers"]["lte-rrc.DL_CCCH_Message_element"]["lte-rrc.message_tree"]["lte-rrc.c1_tree"]["lte-rrc.rrcConnectionReestablishment_element"]["lte-rrc.criticalExtensions_tree"]["lte-rrc.c1_tree"]["lte-rrc.rrcConnectionReestablishment_r8_element"]["lte-rrc.nonCriticalExtension_element"]["per.octet_string_length"])
					nonCritical_opt1.append(json_data[i]["_source"]["layers"]["lte-rrc.DL_CCCH_Message_element"]["lte-rrc.message_tree"]["lte-rrc.c1_tree"]["lte-rrc.rrcConnectionReestablishment_element"]["lte-rrc.criticalExtensions_tree"]["lte-rrc.c1_tree"]["lte-rrc.rrcConnectionReestablishment_r8_element"]["lte-rrc.nonCriticalExtension_element"]["per.optional_field_bit"])
...
with open('uncongested_botanical_night_reestablish_accept.csv', 'w') as myfile:
...
# print export_data
# export_data = zip_longest(*d, fillvalue = '')
with open('uncongested_horton_night_reestablish_accept.csv', 'w') as myfile:
      wr = csv.writer(myfile)
      wr.writerow(("Frame Number", "Epoch", "Reject OptField", "Wait Time", "Payload Length", "nonCritical Field", "count"))
      for rows in export_data:
      	wr.writerow(rows)
